...
export default function Confirm({ open, title = 'Confirm', message = 'Are you sure?', onConfirm, onCancel }: Props) {
  if (!open) return null
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded shadow-lg w-full max-w-sm mx-4 p-4 z-10">
        ...
        <div className="flex justify-end gap-2">
          <button className="px-3 py-1 rounded bg-gray-200 hover:bg-gray-300" onClick={onCancel}>Cancel</button>
